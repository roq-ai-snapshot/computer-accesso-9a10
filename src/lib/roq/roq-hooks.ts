...
export function useWishlistFindMany<
  T extends Prisma.wishlistFindManyArgs,
  R extends GetFindResult<Prisma.$wishlistPayload<DefaultArgs>, T>[],
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWishlistFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.wishlist.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWishlistCount<T extends Prisma.wishlistCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.wishlistCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useWishlistCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.wishlist.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWishlistFindManyWithCount<
  T extends Prisma.wishlistFindManyArgs,
  R extends { data: GetFindResult<Prisma.$wishlistPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.wishlistFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWishlistFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.wishlist.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWishlistFindFirst<
  T extends Prisma.wishlistFindFirstArgs,
  R extends GetFindResult<Prisma.$wishlistPayload<DefaultArgs>, T>,
>(
  args?: Prisma.SelectSubset<T, Prisma.wishlistFindFirstArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useWishlistFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.wishlist.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
