...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`computer accessories shop `}</title>

        <meta
          name="description"
          content="Welcome to Computer Accessories Shop, your one-stop destination for all your computing needs. Enhance your digital experience with our high-quality products."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1577375729078-820d5283031c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb21wdXRlciUyMGFjY2Vzc29yaWVzfGVufDB8fHx8MTY5ODA0Mzk0Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@pakata?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Pakata Goh`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Computer Accessories Shop, your one-stop destination for all your computing needs. Enhance your digital experience with our high-quality products.`}
            </Text>
            <Box
