...
import { useRoqPlatformUserProfiles, useReviewCount, useWishlistCount, useProductCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const wishlistStat = useWishlistCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Wishlists',
      result: wishlistStat?.data,
      isLoading: wishlistStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Products',
