...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['company', 'order.count', 'review.count', 'wishlist.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('review', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('wishlist', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'wishlist',
          header: 'Wishlist',
          accessorKey: 'wishlist',
          cell: ({ row: { original: record } }: any) => record?._count?.wishlist,
        }
      : null,
