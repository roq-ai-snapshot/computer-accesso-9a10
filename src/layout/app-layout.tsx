...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'manager', 'sales-representative', 'customer-service-representative', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Wishlists', path: '/wishlists', entity: 'wishlist', service: AccessServiceEnum.PROJECT, icon: FiHeart },
